...
"""
Class for calculations related to the magnetic circuit
"""

class MagneticCircuit:

    def __init__(self, gap_magnetic_flux_density, bore_radius, n_pole, lz_machine, b_of_h, n_stator_slot, n_rotor_slot, stator_yoke_thickness, rotor_yoke_thickness, stator_slot_width, rotor_slot_width, stator_slot_length, rotor_slot_length):
        ...
        self._rotor_slot_width = rotor_slot_width
    ...
    @property
    def get_stator_slot_width(self):
        return self._stator_slot_width

    @property
    def get_rotor_slot_width(self):
        return self._rotor_slot_width

    @property
    def get_stator_yoke_thickness(self):
        return self._stator_yoke_thickness

    @property
    def get_rotor_yoke_thickness(self):
        return self._rotor_yoke_thickness

    @property
    def get_stator_slot_length(self):
        return self._stator_slot_length

    @property
    def get_rotor_slot_length(self):
        return self._rotor_slot_length

    # Private function to easily calculate surfaces
    def __get_surface(self, width, n_slot):
        return width * self._lz_machine*n_slot/self._n_pole
    ...
    def get_stator_teeth_magnetic_surface(self):
        return self.__get_surface(self._stator_slot_width, self._n_stator_slot)

    @property
    def get_rotor_teeth_magnetic_surface(self):
        return self.__get_surface(self._rotor_slot_width, self._n_rotor_slot)
    ...
    """
    Calculation of Magnetic Flux Density (B) and create a MagneticParameters for it to get H easily
    """
    ...
    @property
    def get_gap_magnetic_flux_density(self):
        return MagneticParametersFromMagneticFluxDensity(self._gap_magnetic_flux_density, BOfH_Air())
